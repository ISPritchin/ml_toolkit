...
from ml_toolkit.models._utils import CLS_METRICS, fit_calibrator, prep_cat_features, resolve_metric_fn
...
def train_regression(*args, **kwargs):
    raise NotImplementedError(
        "LightGBMRanker не поддерживает регрессию. "
        "Для регрессии используйте 'lightgbm'."
    )
...
def train_classification(
    ...
    model = LightGBMRanker(n_optuna_trials=n_optuna_trials, model_settings=model_settings or {})
