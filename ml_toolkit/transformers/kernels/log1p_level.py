...
Signal:
    Логарифмически сжимает масштаб значений: позволяет сравнивать ряды с разным
    масштабом и работать с признаками в log-шкале без потери знака.
    Устойчив к экспоненциальному распределению значений.
...
Interpretation:
    ...
    Разница log1p между двумя рядами примерно равна log-ratio их уровней.
