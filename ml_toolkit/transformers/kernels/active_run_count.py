...
Signal:
    Считает, сколько раз ряд «включался» после паузы в течение окна.
    Высокое значение — дробный пульсирующий паттерн (много отдельных эпизодов активности).
...
Interpretation:
    active_run_count_w12 = 1 при active_months_w12 = 12 — непрерывная активность без пауз.
