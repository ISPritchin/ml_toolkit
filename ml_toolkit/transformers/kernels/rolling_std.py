...
Signal:
    ...
    на уровень, поэтому крупные клиенты автоматически имеют большее std. Полезен как
...
Interpretation:
    ...
    В паре с mean через CV позволяет сравнивать клиентов с разным масштабом бизнеса.
