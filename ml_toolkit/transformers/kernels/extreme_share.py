...
Signal:
    ...
    Используется для отличия «спокойных» клиентов от волатильных.
...
Interpretation:
    extreme_w12 > 0.3 — более 30% месяцев выходят за 1.5σ: нестабильный клиент.
    balance_w12 > 0.2 — клиент больше времени проводит выше среднего (восходящий тренд).
    balance_w12 = 0 при высоком extreme — осцилляция симметрична (ни рост ни падение).
    extreme близко к 0 при balance ≈ 0 — стабильный клиент около своего среднего.
