...
Signal:
    ...
    находится ли клиент на «выходе из дна» (trough недавно) или «уходящем от пика»
...
Interpretation:
    months_since_trough_w12 = 5 при max_drawdown_w12 > 0.9 — клиент восстанавливается 5 мес после глубокого дна.
