...
Signal:
    ...
    (близко к 1) — значения равномерны; низкая — сконцентрированы в нескольких
    месяцах (редкие крупные всплески на фоне остальных).
...
Interpretation:
    ≈ 1.0 — значения равномерно распределены по всем месяцам окна.
    ≈ 0.5 — умеренная концентрация (половина объёма в 2-3 месяцах).
    ≈ 0.0 — весь объём сосредоточен в одном месяце (единичный крупный выброс).
