...
Signal:
    Показывает регулярность ненулевых значений ряда в периоде. Высокое значение
    означает стабильный, непрерывный поток наблюдений, низкое — прерывистую или сезонную активность.
...
Interpretation:
    active_months_w12 = 12 — ряд активен (ненулевой) каждый месяц.
    active_months_w12 = 3–5 — редкие, но крупные ненулевые наблюдения.
    active_months_w12 = 0–1 — практически неактивный ряд или короткая история.
