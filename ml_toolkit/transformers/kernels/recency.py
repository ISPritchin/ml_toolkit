...
Signal:
    Измеряет, как давно ряд проявлял активность. recency_gap = 0 означает активность
    прямо сейчас; большие значения — ряд давно молчит. -1 = активности
    ещё не было (наблюдений ещё не поступало).
...
Interpretation:
    ...
    > 6 — 6+ месяцев молчания подряд.
    = -1 — ещё не было ни одного ненулевого значения.
