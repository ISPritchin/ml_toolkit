...
Signal:
    ...
    1 — весь объём в одном месяце. Высокий gini при высоком mean — ряд с редкими
    крупными всплесками, низкий — равномерный поток.
...
Interpretation:
    ...
    gini_w12 > 0.6 — экстремальная концентрация (1-2 месяца дают почти весь объём).
