...
Signal:
    ...
    Высокий spike_count при низком crash_count — ряд с нечастыми, но крупными
    всплесками значений. Наличие is_spike_now = 1 означает аномально сильный текущий месяц.
...
Interpretation:
    ...
    crash_count > 2, balance < 0 — волатильный ряд со склонностью к обвалам.
    recency = 0 — только что был экстремум (будь то всплеск или падение).
    is_spike_now = 1 — текущая точка сама является аномальным выбросом.
