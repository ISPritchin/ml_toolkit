...
Signal:
    Показывает, стабильно ли клиент удерживает «хорошие» или «плохие» позиции
    в своей истории. Высокий above_med при высоком q_stability — устойчиво выше медианы.
    rank_trend — улучшается ли позиция клиента в последнее время.
...
Interpretation:
    ...
    rank_trend > 0 — ранги последовательно растут (клиент улучшает позицию).
