...
Signal:
    Простейшие MoM-индикаторы изменения: насколько выросло/упало значение ряда за
    последний месяц в абсолютных единицах, в log-шкале и в процентах. Логарифмическая
    разность устойчива к экспоненциальному распределению значений.
