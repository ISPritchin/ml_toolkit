...
Signal:
    Показывает, насколько текущий уровень ниже исторического пика ряда.
    Значение 0 — ряд на историческом максимуме прямо сейчас. Большое отрицательное
    значение — ряд далеко от своего пика (глубокая просадка или стагнация после пика).
...
Interpretation:
    = 0 — ряд устанавливает новый исторический максимум (is_new_peak = 1).
    = -0.1 — на 10% ниже исторического пика, небольшая коррекция.
    < -0.5 — ряд упал более чем на 50% от пика: критическое снижение.
