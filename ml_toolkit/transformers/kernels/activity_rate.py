...
Signal:
    Отражает, насколько плотно заполнен ряд ненулевыми значениями за весь период с первого
    ненулевого наблюдения. Близко к 1 — ряд активен практически каждый месяц.
...
Interpretation:
    > 0.9 — практически непрерывный ряд, без пропусков.
    0.4–0.9 — смешанный паттерн, возможна сезонность или длинные провалы в активности.
    < 0.3 — редкая активность, большинство месяцев нулевые.
