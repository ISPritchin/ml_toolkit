...
Signal:
    Разграничивает «органичный» рост (много равных небольших приростов) от «скачкообразного»
...
Outputs:
    ...
    {product}__growth_quality__neg_sum_share_w12 — доля суммарных потерь к среднему уровню ряда
...
Interpretation:
    ...
    organic_w12 ≈ 0 — весь рост от одного крупного скачка (разовый, нестабильный).
