...
1. Margin: minority-класс получает больший обязательный отступ от границы
...
2. Deferred Re-Weighting (DRW): первые reweight_epoch_frac * n_total_iterations
   ...
   Ранняя фаза без перевзвешивания даёт модели сначала выучить общую форму границы,
