"""Тесты для TabMRegressor/TabMClassifier (ml_toolkit/models/_tabular/_automl/_tabm.py).
...
from ml_toolkit.models._tabular._automl._tabm import TabMClassifier, TabMRegressor
