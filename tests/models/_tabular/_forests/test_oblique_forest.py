"""Тесты для ObliqueForestRegressor/ObliqueForestClassifier (ml_toolkit/models/_tabular/_forests/_oblique_forest.py).
...
from ml_toolkit.models._tabular._forests._oblique_forest import ObliqueForestClassifier, ObliqueForestRegressor
