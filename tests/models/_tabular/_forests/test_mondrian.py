"""Тесты для MondrianForestRegressor/MondrianForestClassifier (ml_toolkit/models/_tabular/_forests/_mondrian.py).
...
from ml_toolkit.models._tabular._forests._mondrian import MondrianForestClassifier, MondrianForestRegressor
