"""Тесты для MARSRegressor/MARSClassifier (ml_toolkit/models/_tabular/_interpretable/_mars.py).
...
from ml_toolkit.models._tabular._interpretable._mars import MARSClassifier, MARSRegressor
