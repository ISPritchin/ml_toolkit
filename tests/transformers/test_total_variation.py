...
def test_full_output_vector():
    ...
    assert _get(arrs, sfxs, 'w4') == pytest.approx([0.0, 6.0, 18.0, 21.0, 24.0, 27.0, 35.0, 30.0, 35.0], abs=1e-6)
    assert _get(arrs, sfxs, 'norm_w4') == pytest.approx([0.0, 2.0, 3.0, 3.111111, 4.571429, 3.0, 5.0, 6.315789, 3.589744], abs=1e-6)
